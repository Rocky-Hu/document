...
~~~
[root@10 ffmpeg-4.4]# ./configure --help
...
https://packages.ubuntu.com/hirsute/amd64/libdav1d4/download

sudo apt update

~~~
./ffmpeg -i rtsp://wowzaec2demo.streamlock.net/vod/mp4:BigBuckBunny_115k.mov -vcodec libx264 -acodec copy -f flv rtmp://127.0.0.1:1935/mylive/1 -loglevel debug
